...
The model is calibrated to naturalized flow time series generated by Associated (2019), with a focus on capturing both peak flows AND low flows.
...
#SPATIAL COVERAGE:
This model includes 21 subbasins that cover the Coldstream Creek watershed with 1,768 HRUs.
There are 1 reservoirs represented in this model.
